...
const CUTE_GREETINGS = [
  "Hello! Ready to find your next favorite outfit? Let's check some style reviews! 🧥✨",
  "Hey there! Welcome to Trend & Tailor! Let's explore some modern unisex lookbooks! 💼🕶️",
  "Glad you're here! Let's style your week with these aesthetic clothing reviews! 🧥⚡",
  "Hello friend! May your day be as sharp and clean as your outfits! ✨👟",
  "Sending you warm wardrobe vibes and lots of daily style inspiration! 💌👕",
  "Hey! Have a super chic, comfortable, and fashionable day! 👟✨",
  "Welcome! You look absolutely amazing today, never forget it! 🌟🧣",
];
    ...
    <div className="phone-frame">
      ...
      <section
        style={{
          ...
          padding: "16px",
          background: "linear-gradient(135deg, #faf6f0 0%, #f3ede2 100%)",
          border: "2px dashed #d3c9b9",
          borderRadius: "24px",
          display: "flex",
          alignItems: "center",
          gap: "16px",
      ...
      >
        ...
        <div
          style={{
            ...
            boxShadow: "0 4px 10px rgba(171, 122, 94, 0.1)",
            display: "flex",
            alignItems: "center",
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              fontWeight: 700,
              cursor: "pointer",
              boxShadow: "0 2px 4px rgba(171,122,94,0.05)",
      ...
      <section className="girly-hero" style={{ padding: "16px 20px 14px" }}>
        ...
        <p className="girly-subtitle">
          Explore premium outfit lookbooks and clothing reviews shared by style enthusiasts! ✨ Select your favorite platform to view.
        </p>
      </section>
